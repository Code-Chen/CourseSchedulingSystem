...
class CollegeRole extends PureComponent {
    ...
    getTableData=(param)=>{
        ...
        axios.post('/queryCoursePlan', param).then((res) => {
            if (res.data.code === '1') {
...
const CollegeRolePage = Form.create()(CollegeRole);

export default CollegeRolePage;